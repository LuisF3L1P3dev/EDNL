...
public class ArvoreBlacklist {
    ...
    public void inserir(long ip) {
        /* E necessario receber a raiz devolvida pelo metodo recursivo. Quando a arvore esta vazia, o novo no passa a ser a raiz.*/
    ...
    public boolean buscar(long ip) {
        ...
        if (encontrado == null) {
            System.out.println("IP " + ip + " nao esta bloqueado.");
            return false;
        }

        System.out.println("IP " + ip + " esta bloqueado. Tentativas registradas: " + encontrado.contadorTentativas);
        return true;
    }
    ...
    private void relatorioOrdenado(NoIP atual) {
        ...
        System.out.println("- IP " + atual.ip + " | tentativas: " + atual.contadorTentativas);
    ...
    public boolean remover(long ip) {
        ...
        if (localizar(ip) == null) {
            System.out.println("IP " + ip + " nao foi removido porque nao esta na blacklist.");
            return false;
        }
    ...
    private NoIP remover(NoIP atual, long ip) {
        ...
        if (ip < atual.ip) {
            ...
            /** CASO 1: nenhum filho.* Como os dois filhos sao null, devolver atual.direito devolve null.
             * CASO 2: somente filho direito.Devolver o filho direito liga esse filho diretamente ao no pai.*/
